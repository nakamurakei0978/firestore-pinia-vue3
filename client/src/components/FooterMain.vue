    ...
    <div class="bg-white dark:bg-gray-900 mt-10">
      <div class="mx-auto max-w-screen-xl px-4 pb-8 pt-16 sm:px-6 lg:px-8 lg:pt-24">
        <div class="text-center">
          ...
          <a
            href="#"
            class="mt-8 inline-block rounded-xl border border-green-600 px-12 py-3 text-sm font-medium text-white hover:bg-green-600 hover:text-white focus:outline-none duration-200 active:bg-green-500"
          >
            Shop
          </a>
        </div>
        ...
        <div
          class="mt-16 border-t border-gray-100 pt-8 dark:border-gray-800 sm:flex sm:items-center sm:justify-between lg:mt-24"
        >
